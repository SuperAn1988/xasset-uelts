...
namespace xasset
{
    public class Manifest : ScriptableObject
    {
        ...
        public int version;
        public BuildVersion binaryVersion;
        ...
        private void OnLoad()
        {
            ...
            if (binaryVersion != null && (binaryVersion.size == 0 || string.IsNullOrEmpty(binaryVersion.file)))
            {
                binaryVersion = null;
            }
        }
        ...
        public bool IsRawAsset(string path)
        {
            return nameWithBundles.TryGetValue(path, out var value) && value.isRaw;
        }
    }
}